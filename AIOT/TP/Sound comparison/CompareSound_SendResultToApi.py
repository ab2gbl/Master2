...
class App2CompareSound(QtWidgets.QMainWindow):
    ...
    def plotComparison(self, x, y, sr1, sr2):
        ...
        print("Saving comparison to database...")
    ...
    def saveComparisonToDatabase(self, waveform_path):
        ...
        #print("start uploading",waveform_path)
        pic_url=upload_image(waveform_path)
        #print("end uploading")

        url="http://192.168.71.75:8000/comparative-sounds"
        #url="https://webhook.site/497c360d-00eb-4284-8b9e-d5b62191da3c"
        headers = {
            "Content-Type": "application/json"
        }
        data={
            #"recorded_at":func.now(), 
            "waveform_image": pic_url,
            "difference_percentage": self.res,
            } 
        ...
        if response.status_code == 200:
            ...
            self.status_label.setText(f"Error saving comparison to DB: {response.text}")
